...
const userSchema = new Schema({
  ...
  province: {
    type: Object,
    default: { name: "广西壮族自治区", value: "530000" },
  }, // 省
  city: { type: Object, default: { name: "玉林市", value: "537000" } }, // 市
  town: { type: Object, default: { name: "容县", value: "537500" } }, // 县
  sex: { type: String, default: "3" }, // 0 男 1 女 3 保密
  bubble: { type: String, default: "vchat" }, // 气泡
  chatColor: { type: String, default: "#ffffff" }, // 聊天文字颜色
  bgOpa: { type: Number, default: 1 }, // 聊天框透明度
